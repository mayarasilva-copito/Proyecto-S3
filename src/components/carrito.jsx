...
function Carrito() {
  ...
  return (
    <div className="carrito-page">
      <h1 className="titulo-carrito">🛒 Carrito de Adopción hola</h1>

      {adoptadas.length === 0 ? (
        <p className="mensaje-vacio">
          Aún no se ha agregado ninguna mascota 🐶🐱
        </p>
      ) : (
      ...
      <div className="botones-carrito">
        ...
        <button
          ...
          onClick={() => navigate('/Listademascotas')}
        >
          🔄 Volver a Mascotas
        </button>
      </div>
